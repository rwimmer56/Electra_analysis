...
### Setup
Get a pre-trained ELECTRA model downloading the release ELECTRA weights and unziping them under `$DATA_DIR/Electra_analysis/electra/models/electra_large/`
...
sh train.sh
```
 This will produce the Results folder where the model's performance will be evaluated and the specific predictions will be created. 
